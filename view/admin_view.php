<div class='container'>
	...
	<h1 class='pull-left text-warning' style='width:100%' >You Are Now Entering Admin Site.<a href="logout.php" class='btn btn-success pull-right'>Log Out</a></h1>
	...
	<div class='row'>
		...
		<div class='col-sm-6 col-md-4'>
			<div class="thumbnail">
			  ...
			  <img src="/onestophealthcare/res/img/chat.png" >
			  <div class="caption">
		...
		<div class='col-sm-6 col-md-4'>
			<div class="thumbnail">
			  ...
			  <div class="caption">
				...
				<p class='text-center'><br/>
				<a href="hospital.php" class="btn btn-info" role="button">Manage </a>
